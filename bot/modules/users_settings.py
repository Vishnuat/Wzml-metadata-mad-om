...
desp_dict = {
    ...
    "lmetadata_key": [
        "File Data Will Be Edit With Your Channel Name.",
        "Send Your Channel.\n\nExample: Telegram Channel ~ @YourChannel\n\n<b>Timeout:</b> 60 sec",
    ],
    "mprefix": [
...
async def get_user_settings(from_user, key=None, edit_type=None, edit_mode=None):
    ...
    if key is None:
        ...
        text = BotTheme(
            ...
            DC=from_user.dc_id,
            THUMB="Exists ✅️" if await aiopath.exists(thumbpath) else "Not Exists🚫",
        )
        ...
        lmetadata_key = user_dict.get("lmetadata_key") or "Not Exists"
        buttons.ibutton(
            f"{'✅' if lmetadata_key != 'Not Exists' else ''} Metadata",
            f"userset {user_id} lmetadata_key",
        )
